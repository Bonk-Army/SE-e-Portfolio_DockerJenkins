...
<div class="reveal">
    ...
    <div class="slides" id="introduction">
        ...
        <section>
            ...
            <ol type="1">
                <li>Docker</li>
                <li>Live-Demo for Docker</li>
                <li>Jenkins</li>
                <li>Live-Demo for Jenkins</li>
    ...
    <div class="slides" id="docker" style="">
        ...
        <section>
            <aside class="notes">
                <ul>
                    <li>Table of Content for my Part about Docker</li>
                    <li>Roughly 15 Minutes</li>
                    <li>4 Main Points</li>
                    <li>Starting at IT Landscape</li>
                    <li>Transition</li>
                    <li>Going into Docke</li>
                </ul>
            </aside>
            <h1>Contens</h1>
            <ol>
        ...
        <section>
            <aside class="notes">
                <ul>
                    <li>Mostly Monoliths</li>
                    <li>Now many Microservices which can be made by Docker</li>
                </ul>
            </aside>
        ...
        <section>
            ...
            <section>
                ...
                <img src="https://lh3.googleusercontent.com/proxy/CTmkFu40k5DI4O-m0F3T0uN89cDVHf8aUX0bbRNaERVxezwaTb1d7dDlM00fjUnEm6scG3l_vOO6bQ8K557XlROHHUV4b_Jkk_xW2tA">
            </section>
            <!-- Docker Image-->
            <section>
                <img width="40%" ,
            ...
            <section>
                <h1>Layer</h1>
                <p class="fragment" data-fragment-index="1">Part of an Image</p>
            ...
            <section>
                <h1>Image</h1>
                <p class="fragment" data-fragment-index="1">Image of an "Container"</p>
            ...
            <section>
                <h1>Container</h1>
                <p class="fragment" data-fragment-index="1">Instanced version of an Image</p>
            ...
            <section>
                <h1>Dockerfile</h1>
                <pre><code data-trim data-noescape data-line-numbers="10-11">
            ...
            <section>
                ...
                <p class="fragment" data-fragment-index="2">Volumes are "mounted" into an Container</p>
            ...
            <section>
                <h1>Node</h1>
                <p class="fragment" data-fragment-index="1">VM or physical Machine, which is a member of an Network</p>
        ...
        <section>
            <section>
                <h1>Positiv Aspects of Containers</h1>
            </section>
            <section>
                Easy Deployment
            </section>
        ...
        <section>
            ...
            <style>
                ...
                .tl-timemarker.tl-timemarker-active .tl-timemarker-timespan {
                    background-color: rgb(9 156 236);
                }
            ...
            <script type="text/javascript">
                var additionalOptions = {
                    default_bg_color: {r: 25, g: 25, b: 25},
                }

                timeline = new TL.Timeline('timeline-embed',
                    'https://docs.google.com/spreadsheets/d/11Asdm-P3S2ehchGg0tvwSiJbfr7B8TukHCH-YNQ2Fcw/pubhtml',
                    additionalOptions);
            </script>
        </section>
        <!-- Docker Architektur -->
        <section>
            <h1>Docker Architektur</h1>
            <img src="https://www.01net.it/wp-content/uploads/sites/14/2017/07/container-devops.png">
        </section>
        <!-- Docker Workflow -->
        <section>
            <h1>Docker Workflow</h1>
            <img src="https://cdn.stereolabs.com/docs/docker/images/docker-jetson-workflow.jpg">
        </section>
        <!-- Live Demo -->
        <section style="width: 100%;height: 85%;padding-top: 50px">
            ...
            <aside class="notes">
                <code>
                    docker run --name nginxTest -d -p 8080:80 nginx:latest
                </code>
            </aside>
        </section>
    </div>
        ...
        <section>
            ...
            <section>
                <ul>
                    ...
                    <li>What is Jenkins capable of?</li>
